...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\dougk\\Desktop\\SpatialMem11.12.19\\spatialMemB2_lastrun.py',
...
path = 'https://gitlab.pavlovia.org/lcdlab/spatial-memory'
os.chdir(path)
